...
=================================================
- This is a stored procedure to load data into silver schema from bronze Schema.
---it preforms the ETL process before loading into silver schema.
Actions
-- Truncate Silver Tables
--Insert transformed data into cleaned data from bronze to silver
...
BEGIN TRY
		...
		PRINT '>> INSERTING Data into : silver.crm_ssales_details'
